#de with the Excel file creation and updating integrated into your original code. The changes are mostly around loading and saving the attendance data to the Excel file.
